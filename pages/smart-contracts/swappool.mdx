...
The sarafu.network permissioned swap pool enables users to deposit and exchange (withdraw) community asset vouchers (CAVs), with prices being determined by their relative values against each other.

## Source code

* https://github.com/grassrootseconomics/erc20-pool
